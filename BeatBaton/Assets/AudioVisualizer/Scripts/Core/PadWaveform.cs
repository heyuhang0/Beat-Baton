...
namespace AudioVisualizer
{
    ...
    public class PadWaveform : MonoBehaviour
    {
        ...
        public void SendRipple(float delayTime)
		{
            ...
            StartCoroutine(RipIt(3, samples, delayTime));
            // Debug.Log("Ripple");
		}
		 ...
		 * }
		 * */
        IEnumerator RipIt(float propegationTime, float[] rippleSamples, float delayTime)
        {
            ...
            while (timer <= propegationTime)
            {
                ...
                timer = Time.timeSinceLevelLoad - StartTime - delayTime;
